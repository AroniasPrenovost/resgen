  ...
  return (
    <div className="text-white font-bold py-28 text-center space-y-5">
      ...
      <div className="text-zinc-400 text-xs md:text-sm font-normal p-4">
        Use the power of AI to <b>instantly</b> generate an professional resume optimized for ATS systems (applicant tracking software).<br/><br/>It's simple - you provide as much (or as little) info as you want, and AI does the rest. 
      </div>
    </div>
  );
};
