...
const steps = [
  ...
  {
    label: "03 / DOWNLOAD",
    title: "Preview free, $9.99 for 30 days",
    body: "See the polished version before you pay. Pay $9.99 for 30 days — 30 generations, unlimited downloads. Edit forever in Word or Google Docs.",
