...
export const LandingNavbar = () => {
  return (
    <nav className="sticky top-0 z-50 border-b border-[var(--border-soft)] bg-[rgba(10,11,20,0.85)] backdrop-blur-md">
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <Link
          ...
          prefetch={true}
          className={cn("btn-primary rounded-full px-5 py-2 text-sm font-medium text-white")}
        >
          Build my resume
        </Link>
      </div>
