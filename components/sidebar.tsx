      ...
      <div className="px-3 py-2 flex-1">
        ...
        <div className="space-y-1">
         ...
         {/*       <li><b>1. </b><b style={{color:"orange"}}>$3.99</b> gets you access for 30 days.</li>
                ...
                <br/>
                <li>A <b>one-time</b> payment of <b style={{ color: "orange"}}>$9.99</b> gets you access to the generator for <b>30</b> days, <em>in addition to</em> real human chat support.</li>
                <br/>
                <li><em>Pro tip:</em> If you do not own Microsoft Word, upload the downloaded file to <Link className={cn(
