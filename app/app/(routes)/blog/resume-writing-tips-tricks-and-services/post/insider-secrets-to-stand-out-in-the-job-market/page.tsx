 ...
 return (
   <article className="min-h-screen bg-gray-50">
     ...
     <section className="px-8 lg:px-16 py-0 space-y-6">
       ...
       <p className="text-gray-700 custom_html">
         Face it - crafting a stellar resume is an art form. If youapos;re ready to take it to the next level, get started now with our <a href="https://www.resumai.services/app/resume-generator" className="text-blue-700 hover:underline" title="ResumAI - Resume Generator">Resume Generator</a>!
       </p>
     </section>
